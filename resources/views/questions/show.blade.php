                ...
                <div class="card-body">
                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            ...
                            <span class="votes-count">1123</span>
                            <a title="This question is not useful" class="vote-down off"><i class="fas fa-caret-down fa-3x"></i></a>
                            <a title="Click to mark as favorite answer (click again to undo)" class="favorite mt-2 favorited"><i class="fas fa-star fa-2x "></i>
                    ...
                    @foreach ($question->answers as $answer)
                        <div class="media ">
                            <div class="d-flex flex-column vote-controls">
                                ...
                                <a title="Mark this answer an best answer" class="vote-accepted mt-2 "><i class="fas fa-check fa-2x "></i>
                                    <span class="favorites-count">123</span>
                                </a>
                            </div>
                            <div class="media-body">
